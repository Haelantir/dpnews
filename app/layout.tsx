    ...
    <html lang="ko">
      ...
      <body>
        ...
        <footer className="site-footer">
          <p>서울집주인은 국토교통부 실거래가 데이터를 기반으로 서울 아파트 매매 정보를 제공합니다. 예산별 아파트 검색, 신고가·특이거래 탐지, 지역별 대장아파트, 구별 시세 순위를 독자적인 시스템으로 구현해 복잡한 부동산 데이터를 누구나 쉽고 직관적으로 비교할 수 있습니다. 앞으로 부동산 관련 인사이트를 위한 더 많은 기능도 추가될 예정입니다. 서울집주인이 제공하는 정보는 무단 복제·배포·전송 등에 이용할 수 없으며, 이를 무단 이용하는 경우 저작권법 등에 따라 법적 책임을 질 수 있습니다. 광고 문의 karakoram2310@gmail.com</p>
